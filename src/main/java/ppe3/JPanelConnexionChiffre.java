...
//    }
    ...
    private void jButtonConfirmerConnexionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmerConnexionActionPerformed
        if (panneauIdentifiant.getChamp2().verifIdentifiant() && panneauMdp.getChampSecret1().verifPassword()) {
            ...
            try {
                if (resultat.next()) {
                    lienCV.getInscription().hide();
                    lienCV.getConnexion().hide();
                    lienCV.getjPanelConnexionChiffre1().hide();
//                    lienCV.getjLayeredPaneCreationCV().show();
                    if (resultat.getString("statut").equals("1")) {
                        lienCV.getCreationCV().show();
                        lienCV.getAdministrateur().show();
                    } else {
                        lienCV.getCreationCV().show();
                    }
